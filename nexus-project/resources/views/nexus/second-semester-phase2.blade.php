        ...
        <div id="malware-injections" class="mb-20">
            <div class="bg-gray-800 rounded-xl p-8 border border-red-500 mb-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="malware-card bg-gradient-to-br from-red-900/40 to-orange-900/40 border border-red-500/50 rounded-lg p-6 hover:border-red-400 hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 cursor-pointer group" onclick="openModal('ransomwareModal')">
                    ...
                    <div class="malware-card bg-gradient-to-br from-purple-900/40 to-pink-900/40 border border-purple-500/50 rounded-lg p-6 hover:border-purple-400 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 cursor-pointer group" onclick="openModal('remoteAccessModal')">
                        <div class="text-center">
                    ...
                    <div class="malware-card bg-gradient-to-br from-blue-900/40 to-cyan-900/40 border border-blue-500/50 rounded-lg p-6 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer group" onclick="openModal('ratNukerModal')">
                        <div class="text-center">
                    ...
                    <!-- Card 4: ZPhishing -->
                    <div class="malware-card bg-gradient-to-br from-green-900/40 to-emerald-900/40 border border-green-500/50 rounded-lg p-6 hover:border-green-400 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 cursor-pointer group" onclick="openModal('zphishingModal')">
                        <div class="text-center">
