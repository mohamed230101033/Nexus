        ...
        <div id="screenshots-tab" class="tab-content">
            ...
            <div class="screenshot-gallery">
                <div class="screenshot-item" onclick="openFullscreen('{{ asset('images/phase 2/ZPhishing/s1.png') }}')">
                    ...
                    <p class="text-gray-400 text-sm font-medium">Cloning Zphisher in Kali Linux</p>
                    <p class="text-gray-500 text-xs">Terminal displaying Git clone process for Zphisher in a Kali VM environment</p>
                </div>
                <div class="screenshot-item" onclick="openFullscreen('{{ asset('images/phase 2/ZPhishing/s2.png') }}')">
                    ...
                    <p class="text-gray-400 text-sm font-medium">Zphisher Interface in Kali Linux</p>
                    <p class="text-gray-500 text-xs">Zphisher tool displaying attack options for phishing platforms in a terminal inside Kali Linux VM</p>
                </div>
                <div class="screenshot-item" onclick="openFullscreen('{{ asset('images/phase 2/ZPhishing/s3.png') }}')">
                    ...
                    <p class="text-gray-400 text-sm font-medium">Zphisher Port Forwarding Options</p>
                    <p class="text-gray-500 text-xs">Zphisher prompts user to select a port forwarding method (Localhost, Cloudflared, LocalXpose) within a Kali Linux terminal</p>
                </div>
            </div>
            ...
            <div class="screenshot-gallery">
                <div class="screenshot-item" onclick="openFullscreen('{{ asset('images/phase 2/ZPhishing/s4.png') }}')">
                    ...
                    <p class="text-gray-400 text-sm font-medium">Facebook Page Rendered via Zphisher</p>
                    <p class="text-gray-500 text-xs">A cloned Facebook 'Find Your Account' page displayed in Firefox, generated by Zphisher within a Kali Linux virtual machine</p>
                </div>
                <div class="screenshot-item" onclick="openFullscreen('{{ asset('images/phase 2/ZPhishing/s5.png') }}')">
                    ...
                    <p class="text-gray-400 text-sm font-medium">Zphisher Captures Victim Credentials</p>
                    <p class="text-gray-500 text-xs">Terminal output showing successful credential capture using Zphisher on a Kali Linux VM; includes victim IP and stored login details</p>
                </div>
            </div>
        </div>
    </div>
